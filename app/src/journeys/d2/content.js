...

  {
    ...
    places: [
      ...
      },
      {
        ...
        phrases: [
          { de: 'Ich hätte gerne eine Karte für das Spiel.', en: "I'd like a ticket for the match." },
          { de: 'Wer spielt heute?', en: 'Who is playing today?' },
          { de: 'Tor! Wir haben gewonnen!', en: 'Goal! We won!' },
        ],
        quiz: {
      ...
      },
      {
        ...
        phrases: [
          { de: 'Wie viel kostet der Eintritt?', en: 'How much is admission?' },
      ...
      },
      {
        ...
        phrases: [
          { de: 'Schau mal, ein Surfer!', en: 'Look, a surfer!' },
          { de: 'Ist das Wasser kalt?', en: 'Is the water cold?' },
        ],
        quiz: {
...

  {
    ...
    places: [
      ...
      },
      {
        ...
        phrases: [
          { de: 'Wo geht ihr heute Abend aus?', en: 'Where are you going out tonight?' },
          { de: 'Der Club macht erst um Mitternacht auf.', en: "The club doesn't open until midnight." },
          { de: 'Lass uns tanzen gehen!', en: "Let's go dancing!" },
        ],
        quiz: {
