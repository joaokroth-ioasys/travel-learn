...
// Neighbor/sea labels in world-source coordinates (viewBox 3044 413 520 520).
// Sizes use ~60% of the D2-equivalent scale — readable but subtler on a world map.
const neighborLabels = [
  { name: 'Manche',           x: 3235, y: 548, size: 18 },
  { name: 'Royaume-Uni',      x: 3175, y: 490, size: 18 },
  { name: 'Océan Atlantique', x: 3120, y: 660, size: 18 },
  { name: 'Belgique',         x: 3362, y: 568, size: 18 },
  { name: 'Pays-Bas',         x: 3390, y: 535, size: 16 },
  { name: 'Luxembourg',       x: 3410, y: 597, size: 15 },
  { name: 'Allemagne',        x: 3470, y: 610, size: 18 },
  { name: 'Suisse',           x: 3455, y: 670, size: 16 },
  { name: 'Italie',           x: 3468, y: 722, size: 18 },
  { name: 'Corse',            x: 3415, y: 778, size: 15 },
  { name: 'Espagne',          x: 3240, y: 795, size: 18 },
  { name: 'Méditerranée',     x: 3370, y: 828, size: 18 },
];

export default { ...woMap, cities, statePaths, mainFill: '#E8DDC8', neighborLabels, labelScale: 1.5 };
