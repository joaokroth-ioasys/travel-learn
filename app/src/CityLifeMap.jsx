...
export default function CityLifeMap({ locations, routeDone, onSelect }) {
  ...
  return (
    <div className="cl-map">
      <svg className="cl-map__art" viewBox="0 0 360 460" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        <image href="/city-life-map.jpg" x="0" y="0" width="360" height="460" preserveAspectRatio="xMidYMid slice" />
        <polyline
